CREATE TABLE `courses` ( `id` INT(10) NULL AUTO_INCREMENT , `name` VARCHAR(255) NOT NULL , `periods` TINYINT(3) NOT NULL , `type` TINYINT(3) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
...
CREATE TABLE `professor` ( `id` INT(10) NULL AUTO_INCREMENT , `name` VARCHAR(255) NOT NULL , `slack` VARCHAR(255) NOT NULL , `email` VARCHAR(255) NOT NULL , `whatsapp` VARCHAR(255) NOT NULL , `contact` VARCHAR(255) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
